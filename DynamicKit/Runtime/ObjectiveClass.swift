...
public class ObjectiveCClass <T: NSObject>: RuntimeModificateable {
    ...
    public var ivars: [String] {
        get {
            ...
            for i in (0..<Int(count)) {
                if let unwrapped  = ivarList?[i] {//.unsafelyUnwrapped
    ...
    public var selectors: [Selector]  {
        get {
            ...
            for i in (0..<Int(count)) {
                if let unwrapped  = methodList?[i] {//.unsafelyUnwrapped
    ...
    public var protocols: [String] {
        get {
            ...
            for i in (0..<Int(count)) {
                if let unwrapped  = protocolList?[i] {//.unsafelyUnwrapped
    ...
    public var properties: [String] {
        get {
            ...
            for i in (0..<Int(count)) {
                if let unwrapped  = propertyList?[i] {//.unsafelyUnwrapped
